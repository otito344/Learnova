...
const [loading, setLoading] = useState(false);
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />
          ...
          <Link
            to="/chat"
            className="flex p-3 gap-2 rounded-lg bg-[#1010E9]"
          >
      ...
      <div className="flex-1 p-8">
        ...
        <div className="bg-white shadow px-8 py-5">
          ...
          <p className="text-gray-500">
            Ask questions about your courses and learning materials.
          </p>
        </div>
      ...
      <div className="bg-white shadow p-4 rounded-2xl">
        ...
        <div className="bg-white border-t p-4">
          ...
          <div className="flex gap-4">
            ...
            <button
              onClick={sendMessage}
              className="bg-[#1010E9] text-white px-8 rounded-xl hover:bg-blue-800"
            >
              Send
            </button>
