...
const fetchMaterials = async () => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
          ...
          <Link
            to="/courses"
            className=" p-3 rounded-lg  flex gap-2 bg-[#1010E9] hover:bg-blue-700"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
      ...
      <div className="flex-1 p-8">
        ...
        <div className="bg-white rounded-2xl shadow p-6 mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            This course introduces students to software
            development methodologies, requirements analysis,
  ...
  >
    ...
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="inline-block mt-4 bg-[#1010E9] text-white px-5 py-2 rounded-lg"
    >
      Open File
    </a>
  </div>
        ...
        <div className="bg-white rounded-2xl shadow p-6 mt-8">
          ...
          <div className="w-full bg-gray-200 rounded-full h-4">
            ...
            <div
              className="bg-[#1010E9] h-4 rounded-full"
              style={{ width: "75%" }}
            ></div>
