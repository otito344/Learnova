      ...
      <div className="flex-1 p-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <input
            ...
            className="w-96 px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-600"
          />
        </div>
        ...
        <div className="flex gap-4 mb-8 flex-wrap">
          ...
          <button className="bg-[#1010E9] text-white px-5 py-2 rounded-lg">
            All Courses
          </button>

          <button className="bg-white px-5 py-2 rounded-lg shadow">
            100 Level
          </button>
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          {filteredCourses.map((course, index) => (
            ...
            <Link to={`/course-materials/${course._id}`}>
              <button
                className="mt-6 w-full bg-[#1010E9] text-white py-3 rounded-xl hover:bg-blue-800 transition"
              >
                View Course
              </button>
              </Link>
